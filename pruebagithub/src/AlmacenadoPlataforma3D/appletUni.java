 ...
 */
public class appletUni extends Applet implements ActionListener, KeyListener {
...
public appletUni() {
   ...
   //timer.start();
   Panel p =new Panel();
   p.add(go);//agrega el boton al panel
   add("North",p);
   ...
   u.addBranchGraph(scene);//agrega el scene graph al universo
}
